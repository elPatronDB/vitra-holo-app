...
import { PhotoIcon, SparklesIcon, TrashIcon, ExclamationTriangleIcon, PlayIcon } from '@heroicons/react/24/solid';
    ...
    <div className="flex flex-col gap-6 pb-20">
      ...
      {holograms.length === 0 ? (
        ...
        <motion.div 
          ...
          initial="hidden"
          animate="visible"
          className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 3xl:grid-cols-8 4k:grid-cols-10 gap-4 md:gap-6"
        >
          {holograms.map(holo => (
            <motion.div 
